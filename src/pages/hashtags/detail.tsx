...
export const HashtagsDetail = observer(() => {
  ...
  if (data.detailType === "posts") {
    if (isLogicEmpty(data.posts)) {
      return data.hashtag && <HashtagItem hashtag={data.hashtag} />;
    }
    ...
    return (
      <FlatList
        ...
        ListHeaderComponent={() => data.hashtag && <HashtagItem hashtag={data.hashtag} />}
