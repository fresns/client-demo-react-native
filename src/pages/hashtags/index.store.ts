...
class Store extends BasicStore<Data> {
  ...
  async init() {
    ...
    let requestState = get(fresnsConfig, "channel_hashtag_query_state");
    let requestQuery = parseUrlParams(get(fresnsConfig, "channel_hashtag_query_config"));
    ...
    this.setData({
      title: get(fresnsConfig, "channel_hashtag_name"),
