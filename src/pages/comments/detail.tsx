...
export const CommentsDetail = observer(() => {
  ...
  if (isLogicEmpty(data.comments)) {
    return data.comment && <CommentItem comment={data.comment} />;
  }
  ...
  return (
    <FlatList
      ...
      ListHeaderComponent={() => data.comment && <CommentItem comment={data.comment} />}
