...
export const PostInteraction: React.FC<Props> = observer(({ post }) => {
    ...
    <>
      <Debug
        ...
        records={[
          {
            label: "是否 like",
            value: post.interaction.likeStatus,
            action: "切换",
            onAction: store.onClickPostLike,
          },
          {
            label: "数量 like",
          ...
          {
            label: "是否 dislike",
            value: post.interaction.dislikeStatus,
            action: "切换",
            onAction: store.onClickPostDislike,
          },
          {
            label: "数量 dislike",
          ...
          {
            label: "是否 关注",
            value: post.interaction.followStatus,
            action: "切换",
            onAction: store.onClickPostFollow,
          },
          {
            label: "数量 关注",
          ...
          {
            label: "是否 屏蔽",
            value: post.interaction.blockStatus,
            action: "切换",
            onAction: store.onClickPostBlock,
          },
          {
            label: "数量 屏蔽",
            value: post.blockCount,
          },
          {
            label: "分享",
            value: "点击分享",
